...
public class CurvedBottombar extends BottomNavigationView {
    private Path mPath;
    ...
    public CurvedBottombar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CurvedBottombar(Context context, AttributeSet attrs, int defStyleAttr) {
